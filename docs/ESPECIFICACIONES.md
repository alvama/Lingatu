...
- **Exportar**: descarga `pinboard_AAAA-MM-DD.json` con el array completo de `state.links` (formato idéntico al modelo de datos, sin listas maestras de categorías/etiquetas — se regeneran al importar).

...
| `enlaces_uncategorized_name_v1` | **Nombre de la categoría por defecto**, fijado una sola vez y nunca reescrito por un cambio de idioma. Es la clave que impide que traducir la interfaz parta la colección en dos categorías distintas (4.28, y decisión 58) |
